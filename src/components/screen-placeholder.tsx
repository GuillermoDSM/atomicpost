    ...
    <div className="grid gap-4 lg:grid-cols-[1.5fr_0.9fr]">
      <Card className="rounded-[22px] border-[#ebebea] bg-white shadow-none">
        <CardHeader className="space-y-4">
          <Badge variant="secondary" className="w-fit rounded-full bg-[#fff1e3] px-3 py-1 text-[#c26a18]">
            {eyebrow}
          </Badge>
        ...
        <CardContent>
          <div className="grid gap-3 md:grid-cols-2">
            {bullets.map((bullet) => (
              <div key={bullet} className="rounded-[18px] border border-[#efefee] bg-[#fbfbfa] px-4 py-4 text-sm leading-6 text-slate-700">
                {bullet}
              </div>
            ))}
          </div>
      ...
      <Card className="rounded-[22px] border-[#ebebea] bg-white shadow-none">
        ...
        <CardContent className="space-y-5 text-sm text-slate-700">
          ...
          <Button className="h-11 w-full rounded-2xl bg-[#f28c28] text-white hover:bg-[#df7f20]">
